...
typedef boost::variant<
    double, std::string, string_pair_t, boost::recursive_wrapper<nop_t>,
    boost::recursive_wrapper<uop_t>, boost::recursive_wrapper<bop_t>>
    mx_expr;
...
namespace cereal {
template <class AR> void serialize(AR &ar, synergia::mx_expr &expr) {
