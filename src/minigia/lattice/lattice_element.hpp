...
public:
  ...
  void duplicate_attribute(std::string const &name, std::string const &new_name,
  ...
  void set_double_attribute(std::string const &name, double value,
  ...
  void set_double_attribute(std::string const &name, const char *value,
                            bool increment_revision = true);

  void set_double_attribute(std::string const &name, std::string const &value,
                            bool increment_revision = true);

  void set_default_double_attribute(std::string const &name, double value,
                                    bool increment_revision = true);
  ...
  /// @param increment_revision can be set to false for
  /// attributes that do not affect dynamics
  void set_string_attribute(std::string const &name, std::string const &value,
                            bool increment_revision = true);
  ...
  /// @param val default value if the specified attribute doesnt exist
  std::vector<double>
  get_vector_attribute(std::string const &name,
  ...
  void reset_marker(marker_type t) { markers[(int)t] = false; }
  ...
  bool has_marker(marker_type t) const { return markers[(int)t]; }
  ...
  void set_deposited_charge(double charge, int bunch = 0, int train = 0) const {
    deposited_charge = charge;
  }

  void deposit_charge(double charge, int bunch = 0, int train = 0) const {
    deposited_charge += charge;
  }
  ...
  /// deprecated
  std::map<std::string, std::string> const &get_string_attributes() const {
