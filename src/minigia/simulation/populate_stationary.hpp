...
#include <minigia/foundation/distribution.hpp>
...
void populate_6d_stationary_clipped_longitudinal_gaussian(
    Distribution &dist, Bunch &bunch, std::array<double, 3> const &actions,
    double cdt_min, double cdt_max, NormalForm<order> const &nf) {
#ifdef __CUDA_ARCH__
