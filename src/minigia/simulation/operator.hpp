...
private:
  ...
  virtual void apply_impl(Bunch_simulator &simulator, double time_step,
                          Logger &logger) = 0;
...
private:
  void apply_impl(Bunch_simulator &simulator, double time_step,
...
public:
  ...
  template <class... Args> Independent_operator &append_slice(Args &&...args) {
