...
TEST_CASE("hdf5_file_scalar_read", "[Hdf5_file]") {
  {
    Hdf5_file file("hdf5_file_scalar_read.h5", Hdf5_file::Flag::truncate,
                   Commxx());
  ...
  {
    Hdf5_file file("hdf5_file_scalar_read.h5", Hdf5_file::Flag::read_only,
                   Commxx());
...
TEST_CASE("hdf5_file_kv_read", "[Hdf5_file]") {
  {
    Hdf5_file file("hdf5_file_kv_read.h5", Hdf5_file::Flag::truncate, Commxx());
  ...
  {
    Hdf5_file file("hdf5_file_kv_read.h5", Hdf5_file::Flag::read_only,
                   Commxx());
