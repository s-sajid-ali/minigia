...
if( FFTW_FIND_COMPONENTS )
  foreach( component ${FFTW_FIND_COMPONENTS} )
    ...
    if (${component} STREQUAL "MPI")
      # means we look for the MPI version of FFTW
      set(FFTW_LOOK_FOR_MPI ON)
    endif()
...
if( (NOT PKG_CONFIG_EXECUTABLE) OR
  ...
  if(NOT FFTW_LOOK_FOR_MKL)
    ...
    elseif (FFTW_LOOK_FOR_MPI)
      set(FFTW_libs_to_find "fftw3${FFTW_PREC}_mpi;fftw3${FFTW_PREC};fftw3")
    else()
